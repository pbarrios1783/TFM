...
# Diccionario para mapear tipos de datos con DataFrames
df_map = {
...
# Diccionario que asocia el tipo de datos con las columnas relevantes
columns_map = {
...
def show_page():
    ...
    # Selección del tipo de datos que quiere ver el usuario
    tipo_datos = st.selectbox("Selecciona el tipo de datos que quieres ver", df_map.keys())
    
    # Seleccionar comunidad en una lista desplegable
    ...
    # Filtrar los datos según la comunidad seleccionada
    df_filtrado = df_seleccionado[df_seleccionado['Comunidad Autónoma'] == comunidad_seleccionada]
    
    # Filtrar las columnas importantes según el tipo de datos
